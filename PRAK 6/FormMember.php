<?php
    ...
    $namaMember = $nomorMember = $password = $alamat = $tglMendaftar = $tglBayar = '';
    $errors = array('nama_member'=>'', 'nomor_member'=>'', 'password'=>'', 'alamat'=>'', 'tgl_mendaftar'=>'', 'tgl_terakhir_bayar'=>'');
    ...
    if(isset($_POST['submit'])){
        ...
        if(array_filter($errors)){
            ...
            // create sql
            $sql = "INSERT INTO member(nama_member,nomor_member,password,alamat,tgl_mendaftar,tgl_terakhir_bayar) VALUES('$namaMember', '$nomorMember', '$password', '$alamat', '$tglMendaftar', '$tglBayar')";
